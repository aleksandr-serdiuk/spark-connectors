...
object ReadFromJDBC extends App {
  ...
  checkReadTableTimeDF(prunedJdbcDF.repartition(10))  // Time taken: 320 ms
  ...
  printPartitionsNumber(fromPgDF.repartition(10))
  printPartitionsNumber(prunedJdbcDF)
 ...
 // printPartitionsNumber(fromPgDF.repartition(10)) // Good?
  ...
  val prunedParallelJdbcDF: DataFrame =
    ...
    checkReadTableTimeDF(prunedParallelJdbcDF)  // Time taken: 84 ms
